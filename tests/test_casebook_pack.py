"""Regression checks for the signal-chain-wallet-mark casebook."""
...
from casebook.harness import assert_expected, signal_chain_wallet_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(signal_chain_wallet_mark_summary(), assert_expected())
